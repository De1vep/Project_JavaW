...
//                a.setUsername(rs.getString("username"));
//                a.setPassword(rs.getString("password"));
//                a.setPassword(rs.getString("displayname"));
//                
//                Group gr = new Group();
//                gr.setGid(rs.getInt("gid"));
//                gr.setGname(rs.getString("gname"));
...
//        ArrayList<Account> listAccount = adb.getAllAccount();
//        System.out.println(listAccount);
//        Account acc = new Account();
//        adb.deleteAccount("acbsad");
//        acc.setUsername("thangdz");
//        acc.setPassword("1234");
//        acc.setDisplayName("wonwolf1834");
//        acc.setUsername("thangdz");
//
